...
import it.geoframe.blogspot.snowmelting.snowmelt.HockModel;
...
@Author(name = "Marialaura Bancheri, Giuseppe Formetta, Niccol� Tubini", contact = "")
...
public class SnowMeltingPointCaseHock {
...
//	
	...
	public void process() throws Exception { 
		...
		for (int i=0;i<idStations.length;i++){
			...
			melting = hockModel.computeMelting(combinedMeltingFactor, radiationFactor, temperature, meltingTemperature, shortwave, skyviewValue);
			melting = hockModel.checkMelting(initialConditionSolidWater.get(i)[0], snowfall, melting);
