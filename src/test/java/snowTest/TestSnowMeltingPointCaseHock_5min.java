...
public class TestSnowMeltingPointCaseHock_5min {
	...
	public void Test() throws Exception {
		...
		String inPathToRainfall ="resources/myinput/snowrainsep_precip_10_5min_1_impulso.csv";
		String inPathToSnowfall ="resources/myinput/snowrainsep_snow_10_5min_1_impulso.csv";
		String inPathToAirT ="resources/myinput/airT_10_5min.csv";
		String inPathToSWRB ="resources/myinput/Total_10_5min.csv";
		...
		String pathToSWE= "resources/myinput/SWEHock_1_impulso_5min.csv";
		String pathToMeltingDischarge= "resources/myinput/MeltingHock_1_impulso_5min.csv";
...
//			if(airTReader.tCurrent.contentEquals("2013-11-01 07:00")){
//				System.out.println("2013-11-01 07:00");
//			}
			System.out.println("\n"+airTReader.tCurrent);
